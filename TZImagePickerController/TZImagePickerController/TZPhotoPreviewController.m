...
- (void)configCollectionView {
    ...
    [_collectionView registerClass:[SGVideoPreviewCell class] forCellWithReuseIdentifier:@"SGVideoPreviewCell"];
}
...
- (void)select:(UIButton *)selectButton {
    ...
    if (!selectButton.isSelected) {
        ...
        // 2. if not over the maxImagesCount / 如果没有超过最大个数限制
            ...
            if (model.type == TZAssetModelMediaTypeVideo && _tzImagePickerVc.allowPickingVideo == NO) {
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    {
        SGVideoPreviewCell* cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"SGVideoPreviewCell" forIndexPath:indexPath];
        cell.model = model;
...
- (void)collectionView:(UICollectionView *)collectionView didEndDisplayingCell:(UICollectionViewCell *)cell forItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    else if ([cell isKindOfClass:[SGVideoPreviewCell class]])
    {
        [(SGVideoPreviewCell*) cell stopVideoPlayer];
        [(SGVideoPreviewCell*) cell cleanCell];
    }
}
